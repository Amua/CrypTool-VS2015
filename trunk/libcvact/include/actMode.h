...
namespace act
{
	enum
	{
		...
		READERLIST,
		PINPAD,
		TIMEOUT,								//!< Timeout in seconds \sa ITokenPin::SetParam for \a PinEntry configuration.
		USERNAME,
		INFOTEXT,
		TOKENKEY,								//!< Returns \c PARAM_TRUE if key implements interface \c ITokenKey.
		SIGNCERTIFICATE,
		ENCCERTIFICATE,
		ROOTCERTIFICATE,
		DHCERTIFICATE,
		...
		SLOT_RANGE_END			= SLOT_RANGE_BEGIN + SLOT_RANGE_SIZE,
