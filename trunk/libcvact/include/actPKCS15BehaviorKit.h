...
namespace act
{
	...
	IPKCS15Behavior* CreateJCPKCS15Behavior(const char* mid, IToken* token);
		...
		IPKCS15Behavior* CreateJCPKCS15PACEBehavior(const char* mid, IToken* token);
	...
	IPKCS15Behavior* CreateStarCOSPKCS15Behavior(const char* mid, IToken* token);
		IPKCS15Behavior* CreateStarCOSPKCS15ECBehavior(const char* mid, IToken* token);
	IPKCS15Behavior* CreateTCOS30PKCS15Behavior(const char* mid, IToken* token);
	//IPKCS15Behavior* CreateSECCOSPKCS15Behavior(const char* mid, IToken* token); // to be released

	// third party behavior
	IPKCS15Behavior* CreateEBABehavior(const char* mid, IToken* token);
