...
namespace act
{
	...
	public:
		...
		FileAndLine&		operator()()		{ return *this;		}
		const FileAndLine&	operator()() const	{ return *this;		}
	...
	public:
		static const Location<SourceT> Unknown;
	...
	const Location<SourceT> Location<SourceT>::Unknown(0);

	typedef TypeTag<Location<void> > LocationTag;
...
#	endif
#	define BOOST_LOCATION_FROM_HERE_WITH(type)			LOCATION_FROM_HERE_WITH(BOOST_CURRENT_FUNCTION, type)
